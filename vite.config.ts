  ...
  build: {
    lib: {
      entry: {
        ...
        'components/ResizableDiv/index': resolve(__dirname, 'src/components/ResizableDiv/index.ts'),
        'components/SolidLoader/index': resolve(__dirname, 'src/components/SolidLoader/index.ts'),
        ...
        'components/TextArea/index': resolve(__dirname, 'src/components/TextArea/index.ts'),
        'components/TextInput/index': resolve(__dirname, 'src/components/TextInput/index.ts'),
