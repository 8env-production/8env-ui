      ...
      <Tabs {...args}>
        <Tab label="Первый таб" value="tab1">
          <div style={{ padding: '20px' }}>
            ...
            <p>Это содержимое первого таба. Здесь может быть любой контент.</p>
          </div>
        </Tab>
        <Tab label="Второй таб" value="tab2">
          <div style={{ padding: '20px' }}>
            <h3>Содержимое второго таба</h3>
            <p>А это содержимое второго таба с другой информацией.</p>
          </div>
        </Tab>
    ...
    <div style={{ width: '500px' }}>
      <Tabs {...args}>
        ...
        <Tab label="Настройки" value="settings">
          <div style={{ padding: '20px' }}>
            <h3>Настройки</h3>
            <p>Конфигурация приложения и персонализация.</p>
          </div>
        </Tab>
      </Tabs>
    </div>
    ...
    >
      <div>
        ...
        <Tabs defaultValue="tab1" size="small">
          <Tab label="Таб 1" value="tab1">
            <div style={{ padding: '15px' }}>Содержимое маленького таба</div>
          </Tab>
          <Tab label="Таб 2" value="tab2">
            <div style={{ padding: '15px' }}>Содержимое второго таба</div>
          </Tab>
        </Tabs>
      </div>
      ...
      <div>
        ...
        <Tabs defaultValue="tab1" size="medium">
          <Tab label="Таб 1" value="tab1">
            <div style={{ padding: '20px' }}>Содержимое среднего таба</div>
          </Tab>
          <Tab label="Таб 2" value="tab2">
            <div style={{ padding: '20px' }}>Содержимое второго таба</div>
          </Tab>
        </Tabs>
      </div>
      ...
      <div>
        ...
        <Tabs defaultValue="tab1" size="large">
          <Tab label="Таб 1" value="tab1">
            <div style={{ padding: '25px' }}>Содержимое большого таба</div>
          </Tab>
          <Tab label="Таб 2" value="tab2">
            <div style={{ padding: '25px' }}>Содержимое второго таба</div>
          </Tab>
        </Tabs>
      </div>
    </div>
  ...
  return (
    <div style={{ width: '500px' }}>
      <div style={{ marginBottom: '20px' }}>
        ...
        <button onClick={() => setActiveTab('profile')} style={{ marginRight: '10px' }}>
          Переключить на Профиль
        </button>
        <button onClick={() => setActiveTab('settings')}>Переключить на Настройки</button>
      </div>
